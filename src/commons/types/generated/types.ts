...
export type IQuery = {
  ...
  fetchCrewBoardsBySearch: Array<ICrewBoard>;
  fetchCrewBoardsDeadlineFirst: Array<ICrewBoardAndUser>;
  fetchCrewBoardsLatestFirst: Array<ICrewBoardAndUser>;
  ...
  fetchReviewBoards: Array<Array<IReviewBoard>>;
